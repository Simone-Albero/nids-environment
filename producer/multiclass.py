...
DATASET_PATH = "shared/dataset/unsw/Multi-Test.csv"
TRAIN_META = "shared/dataset/unsw/train_meta_multi.pkl"
...
def prepare_data():
    ...
    class_mapping, _ = utilities.labels_mapping(df, prop)
    ...
    def multi_class_label_conversion(dataset):
        return utilities.multi_class_label_conversion_row(dataset, prop, class_mapping)
