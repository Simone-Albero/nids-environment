...
#MODEL_PATH = "shared/models/unsw/DoS_time.pt"
...
def read_and_predict() -> None:
    ...
    consumer = Consumer("kafka:9092", "time_consumer", lambda x: json.loads(x.decode('utf-8')))
    ...
    try:
        for message in consumer:
            ...
            prediction = classifier.process(row)
